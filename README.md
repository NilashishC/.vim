...
``<Leader>F``         | (sneak) perform new sneak backward onto {char}
``<Leader>f``         | (sneak) perform new sneak forward onto {char}
...
``<Leader>S``         | (sneak) perform new sneak backward onto {char}{char}
``<Leader>s``         | (sneak) perform new sneak forward onto {char}{char}
``<Leader>T``         | (sneak) perform new sneak backward until {char}
``<Leader>t``         | (sneak) perform new sneak forward until {char}
